    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tests', models.ManyToManyField(blank=True, related_name='sponsored_packages', to='labtest.test')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sponsored_packages', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
